...
```
# Intro to Animal Movement Modeling 
...
*NEED TO DESCRIBE CRW IN MORE DETAIL TO LEAD INTO BENEFIT OF CTSP AND ADVANCEMENTS IN DATA PROCESSESSING OF CTSP AND IMPORTANCE OF CTMM TO INTEGRATE CTSP WITH STATS FOR AUTOCORRELATED DATA*
