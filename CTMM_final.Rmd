...
We can consider this *directionally persistent* example a **correlated random walk model**. This means that there is a directional bias to travel. This is a great model to use for animal movement, as animals tend to move in one direction- forward (Codling et al., 2018).

*NEED TO DESCRIBE CRW IN MORE DETAIL TO LEAD INTO BENEFIT OF CTSP*
...
*INTRODUCE CTSP AND CTMM.. ADVANCEMENTS IN DATA PROCESSESSING OF CTSP AND IMPORTANCE OF CTMM TO INTEGRATE CTSP WITH STATS FOR AUTOCORRELATED DATA.. RELATIONSHIP BETWEEN CTMM AND MOVEBANK*
...
**EXPLAIN CTMM.FIT FUNCTION HERE**
