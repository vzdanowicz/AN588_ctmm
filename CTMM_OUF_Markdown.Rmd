...
**Preliminaries**
Install these packages in R: {ctmm}, {curl}, {rlist}?? etc***
...
#NK: here we should probably use Victoria's data loading from ctmm_outline.Rmd so people can use our code to load the data when working through our module. 
